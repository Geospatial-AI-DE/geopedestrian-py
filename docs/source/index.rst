Geospatial Pedestrian API Service
=================================
Solve walking scenarios and determine which places and areas are accessible by a pedestrian.

This modern Python module represents an idiomatic client accessing the `Geopedestrian location services <https://geospatial-ai.de/?rara-portfolio=geospatial-pedestrian-api-service>`__ being hosted on `Rapid API Hub <https://v2.rapidapi.com/gisfromscratch/api/geopedestrian>`__.
